...
public class BootstrapShiroModule extends ShiroWebModule {
  ...
  protected void configureShiroWeb() {
    ...
    addFilterChain("/stuff/allowed/**", filterConfig(AUTHC_BASIC, "yes"),
        filterConfig(PERMS, "yes"));
    addFilterChain("/stuff/forbidden/**", filterConfig(AUTHC_BASIC, "yes"),
        filterConfig(PERMS, "no"));
