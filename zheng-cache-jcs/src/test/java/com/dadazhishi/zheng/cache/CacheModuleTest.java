...
public class CacheModuleTest {
  ...
  public void beforeMethod() {
    Module module = Modules.override(new CacheAnnotationsModule()).with(new JCSCacheModule() {
  ...
  public void factory() {
    ...
    Cache<Integer, Integer> cache = cacheManager.getCache("guice", Integer.class, Integer.class);
    cache.put(1, 1);
    cache.put(2, 2);
    cache.put(3, 3);
