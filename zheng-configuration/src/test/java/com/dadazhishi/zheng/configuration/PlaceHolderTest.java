...
public class PlaceHolderTest {
  ...
  public void shouldReturnNullWhenNullIsProvided() {
    ...
    PlaceHolder placeHolder = new PlaceHolder(new SubsetConfiguration(props));
  ...
  public void shouldReplaceVariables() {
    ...
    PlaceHolder sub = new PlaceHolder(new SubsetConfiguration(props));
  ...
  public void testMissingPropertyIsReplacedWithEmptyString() {
    ...
    new PlaceHolder(new SubsetConfiguration(props)).replace(template);
  }
