...
public class HikariDataSourceWrapperTest {
  ...
  public void get() throws Exception {
    ...
    final MetricsTrackerFactory metricsTrackerFactory = new CodahaleMetricsTrackerFactory(
        metricRegistry);
    ...
    Injector injector = Guice.createInjector(new AbstractModule() {
      ...
      protected void configure() {
        ...
        bindConstant().annotatedWith(Names.named("hikaricp.allowPoolSuspension"))
        ...
        bindConstant().annotatedWith(Names.named("hikaricp.connectionInitSql"))
            .to(connectionInitSql);
        bindConstant().annotatedWith(Names.named("hikaricp.connectionTestQuery"))
            .to(connectionTestQuery);
        bindConstant().annotatedWith(Names.named("hikaricp.connectionTimeout"))
        ...
        bind(Object.class).annotatedWith(Names.named("hikaricp.healthCheckRegistry"))
            .toInstance(healthCheckRegistry);

        bindConstant().annotatedWith(Names.named("hikaricp.idleTimeout")).to(idleTimeoutMs);
        bindConstant().annotatedWith(Names.named("hikaricp.initializationFailTimeout"))
            .to(initializationFailTimeout);
        bindConstant().annotatedWith(Names.named("hikaricp.isolateInternalQueries"))
            .to(isolateInternalQueries);

        bindConstant().annotatedWith(Names.named("hikaricp.leakDetectionThreshold"))
        ...
        bindConstant().annotatedWith(Names.named("hikaricp.validationTimeout"))
