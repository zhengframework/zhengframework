...
public class MySQLModuleTest {
  ...
  public void connection() throws SQLException {
    ...
    dataSourceConfig.setJdbcUrl("jdbc:mysql://127.0.0.1:" + mysqldConfig.getPort() + "/");
    dataSourceConfig.setUsername(mysqldConfig.getUsername());
    dataSourceConfig.setPassword(mysqldConfig.getPassword());
    MySQLModule mySQLModule = new MySQLModule();
    mySQLModule.init(dataSourceConfig);
